<script>
(function gtm_affilinateAfflongDL(cdl, jQ) {
    'use strict';
    if (cdl && jQ) try {
...
(function gtm_attrAffiliatesAffLong(cdl, jQ, afdl) {
    ...
    return afdl || !1
}(!window.CATTDL?!1:window.CATTDL, !window.jQuery?!1:window.jQuery, window.CATTDL.DL_attr_afflong))
</script>
