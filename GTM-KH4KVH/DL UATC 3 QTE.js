<script id='GTM-KH4KVH_UATCDLQuote'>
  (function gtm_uatcdlQuote(jQ, cdl, loc, dl){
    ...
    if ( jQ && cdl && cdl.CATTParams && !dl.some(function(a){return /UATCDL Quote/i.test(a && a.event || '');}) ) try {
      ...
      cdl.error('GTM UK multicom UATCDL Quote: '+e);
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'UATCDL Quote', 'pid': cdpm.pageid || '', 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl.DL_uatc;
