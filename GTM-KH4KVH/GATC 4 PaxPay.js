<script id='GTM-KH4KVH_GATCPaxPay'>
  (function gtm_gatcPaxPay(dl, jQ, cdl, gadl, w, d) {
    'use strict';
    var timeStart = cdl.CATTParams?cdl.CATTParams.timestart:0;
    if (cdl && !dl.some(function(a){return /GATC PaxPay/i.test(a && a.event || '');}) ) try {
      ...
      dl.push({'event': 'GATC PaxPay', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl && gadl;
