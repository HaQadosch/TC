<script id='gtm_uatcdlflightonly'>
(function gtm_uatcdlflightonly(jQ, cdl, loc, dl){
    'use strict';
    if (jQ && cdl && cdl.CATTParams){
        ...
        } catch (e){cdl.error('GTM UK TC UATCDL FlightOnly: '+e)}
        finally {dl.push({'event': 'DLUATC FlightOnly'})}
