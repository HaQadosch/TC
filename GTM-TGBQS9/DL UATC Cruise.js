<script id='gtm_uatcdlcruise'>
(function gtm_uatcdlcruise(jQ, cdl, loc, dl){
    'use strict';
    if (jQ && cdl && cdl.CATTParams){
                ...
                webanalytics    :
                    {
                            ...
                            addproduct      : {
                                ...
                                brand           : (cdpm.touroperator || cdpm.cruiseline || '').toLowerCase() || "",
        ...
        } catch (e){cdl.error('GTM UK TC UATCDL Cruise: '+e)}
        finally {dl.push({'event': 'DLUATC Cruise'})}

        return cdl.DL_uatc
    }
}(!window.jQuery?!1:window.jQuery, !window.CATTDL?!1:window.CATTDL, window.location, window.dataLayer?window.dataLayer:[]))
</script>
