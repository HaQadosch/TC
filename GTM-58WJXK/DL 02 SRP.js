<script id='GTM-58WJXK_cattdlSRP'>
(function gtm_cattdlSRP(jQ, dl, cdl) {
    ...
    if (jQ && jQ.extend && cdl) try {
        ...
        window.dataLayer_N5GRGC && dataLayer_N5GRGC.push({'event': (window.getPageData && window.getPageData(cdpm.urlparams && cdpm.urlparams.pathname)?'CATTDL SRP':'CATTDL LP')})
    }
