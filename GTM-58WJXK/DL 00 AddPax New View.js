<script id='GTM-58WJXK_cattdlAddPaxNewView'>
(function gtm_cattdlAddPaxNewView(jQ, w, dl, cdl, loc) {
    ...
    setTimeout(function cattNewView() {
            if (jQ && cdl) try{
                ...
                var domainName = ({'neckermann':'.neckermann.be'
                })[((/([^\.]*).io|([^\.]*).com|([^\.]*).be|([^\.]*).net/i.exec(location.hostname) || []).filter(function hostname(e){return e}) || ['neckermann']).pop()];
