<script id='GTM-WPN6ZR_cattdlLP'>
  (function gtm_cattdlLP(w, d, dl, cdl) {
    'use strict';
    if (cdl) try {
      var ld = cdl._;
      ...
      dl.push({'event': 'CATTDL LP', 'pid': cdpm.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - dl[0]['gtm.start']});
    }
    return cdl;
  }(window, window.document, window.dataLayer, window.CATTDL))
</script>
