<script id='GTM-WPN6ZR_cattdlOffer'>
(function gtm_cattdlOffer(jQ, w, d, dl, cdl) {
    'use strict'
    if (cdl) try {
      var ld = cdl._;
      ...
      dl.push({'event': 'CATTDL Offer', 'pid': cdpm.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - dl[0]['gtm.start']});
    }
    return cdl
