<script id='GTM-WPN6ZR_UATCInsurance'>
  (function gtm_uatcInsurance(jQ, cdl, uadl, w, d, dl){
    'use strict';
    if (cdl && uadl && !dl.some(function(a){return /UATC Insurance/i.test(a && a.event || '');}) ) try {
      ...
      cdl.error('GTM FR JT MultiTO UATC Insurance: '+e);
    } finally {
