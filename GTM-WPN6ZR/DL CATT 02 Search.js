<script id='GTM-WPN6ZR_cattdlSearch'>
  (function gtm_cattdlSearch(jQ, w, d, dl, cdl) {
    'use strict'
    if (cdl) try {
      var ld = cdl._;
      ...
      dl.push({'event': 'CATTDL Search', 'pid': cdpm.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - dl[0]['gtm.start']});
    }
    return cdl
