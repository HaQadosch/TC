<script id='GTM-WPN6ZR_cattdlInsurance'>
(function gtm_cattdlInsurance(jQ, w, d, dl, cdl) {
    'use strict'
    if (cdl) try {
      var ld = cdl._;
      ...
      window.CATTDL.CATTParams = cdpm;
        ...
        cdl.error('GTM CATTDL Insurance: '+e)
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'CATTDL Insurance', 'pid': cdpm.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - dl[0]['gtm.start']});
    }
    return cdl
