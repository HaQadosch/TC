<script id='GTM-WPN6ZR_cattdlConfirmation_imp'>
(function gtm_cattdlConfirmation_imp(jQ, w, d, dl, cdl) {
    'use strict'
    if (cdl) try {
      var ld = cdl._;
      ...
      dl.push({'event': 'CATTDL Confirmation Imp', 'pid': cdpm.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - dl[0]['gtm.start']});
    }
    return cdl
