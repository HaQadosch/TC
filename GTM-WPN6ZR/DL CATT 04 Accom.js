<script id='GTM-WPN6ZR_cattdlAccom'>
(function gtm_cattdlAccom(jQ, w, d, dl, cdl) {
    'use strict'
    if (cdl) try {
      var ld = cdl._;
      ...
      dl.push({'event': 'CATTDL Accom', 'pid': cdpm.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - dl[0]['gtm.start']});
    }
    return cdl
