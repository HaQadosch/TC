<script id='GTM-WPN6ZR_cattdlQuote'>
(function gtm_cattdlQuote(jQ, w, d, dl, cdl) {
    'use strict'
    if (cdl) try {
      var ld = cdl._;
      ...
      window.CATTDL.CATTParams = cdpm;
        ...
        cdl.error('GTM CATTDL Quote: '+e)
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'CATTDL Quote', 'pid': cdpm.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - dl[0]['gtm.start']});
    }
    return cdl
