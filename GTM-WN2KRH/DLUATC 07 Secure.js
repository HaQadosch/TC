<script id='GTM-WN2KRH_uatcdlSecure'>
  (function gtm_uatcdlSecure(jQ, dl, cdl, loc) {
    ...
    if (jQ && cdl && cdl.CATTParams) try {
      ...
      cdl.DL_uatc = {
        ...
        webanalytics    : {
          ...
          addproduct      : {
            ...
            name            : ((cdpm.accomname || '')+'|'+(cdpm.destairport || cdpm.destinationairportselected || '')+'|'+(cdpm.accomcountry || cdpm.country || '')+'|'+(cdpm.accomregion || cdpm.region || '')+'|'+(cdpm.accomresort || cdpm.resortsearrched || '')).toLowerCase() || "",
          ...
          dimensions      : {
            ...
            dimension13     : {'resortsearched'             : cdpm.resort || cdpm.resortsearched || ''},
      ...
      cdl.error('GTM FR VD UATCDL Secure: '+e)
    } finally {
