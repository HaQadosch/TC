        ...
        cdl.DL_uatc = {
            ...
            webanalytics    :   {
                ...
                dimensions      : {
                    ...
                    dimension15     : {'starrating'                 : cdfc.starrating && cdfc.starrating.join(';') || ''},
                    ...
                    dimension65     : {'facet accomtype'            : cdfc.accomtype && cdfc.accomtype.join(';') || ''},
                    dimension66     : {'facet discountperc'         : discfacets || ''},
                    dimension67     : {'facet zoover'               : cdfc.zooverrating && cdfc.zooverrating.join(';') || ''},
                    dimension68     : {'facet facilities'           : cdfc.facilities && cdfc.facilities.join(';') || ''},
                    dimension70     : {'facet boardbasis'           : cdfc.boardbasis && cdfc.boardbasis.join(';') || ''},
                    dimension70     : {'facet brochure'             : cdfc.brochure && cdfc.brochure.join(';') || ''},
                    ...
                    dimension126    : {'searchtype'                 : cdpm.searchtype || ''},
                    dimension127    : {'destcountry'                : cdpm.country || ''},
                    dimension128    : {'destregion'                 : cdpm.region || ''},
                    dimension129    : {'destresort'                 : cdpm.resort || ''},
