...
(function gtm_uatcPay(jQ, cdl, uadl, w, d, dl){
    ...
    if (cdl && uadl) try {
        ...
        cdl.error('GTM NL NEC UATC Pay: '+e); 
    } finally {     
        window.dataLayer && dataLayer.push({'event' : 'UATC Pay'})
        window.dataLayer_557RZS && dataLayer_557RZS.push({'event' : 'UATC Pay'})
    }
