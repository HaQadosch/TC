<script id='GTM-KMVZTD_cattdlConfirmation_sent'>
(function gtm_cattdlConfirmation_sent(w, dl, cdl) {
    'use strict';
    ...
    if (cdl) try {
      ...
      dl.push({'event': 'CATTDL Confirmation Sent', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl;
