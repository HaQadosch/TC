<script id='GTM-KMVZTD_cattdlDestination'>
(function gtm_cattdlDestination(w, dl, cdl) {
    'use strict';
    ...
    if (cdl) try {
      ...
      dl.push({'event': 'CATTDL Destination', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl;
