<script id='GTM-KMVZTD_cattdlAccom'>
(function gtm_cattdlAccom(w, dl, cdl) {
    'use strict';
    ...
    if (cdl) try {
      ...
      dl.push({'event': 'CATTDL Accom', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl;
