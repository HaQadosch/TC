<script id='GTM-KMVZTD_UATCOffer'>
  (function gtm_uatcOffer(jQ, cdl, uadl, w, d, dl){
    'use strict';
    if (cdl && uadl && !dl.some(function(a){return /UATC Offer/i.test(a && a.event || '');}) ) try {
      ...
      cdl.error('GTM FR TC MultiTO UATC Offer: '+e);
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'UATC Offer', 'pid': (cdpm.pageid || ''), 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - window.dataLayer[0]['gtm.start']})
    }
