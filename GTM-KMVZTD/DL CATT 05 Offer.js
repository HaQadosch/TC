<script id='GTM-KMVZTD_cattdlOffer'>
(function gtm_cattdlOffer(w, dl, cdl) {
    'use strict';
    ...
    if (cdl) try {
      ...
      window.CATTDL.CATTParams = cdpm;
        ...
        cdl.error('GTM CATTDL Offer: '+e);
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'CATTDL Offer', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl;
