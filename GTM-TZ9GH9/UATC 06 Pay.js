...
(function gtm_uatcPay(jQ, cdl, uadl, w, d, dl){
    ...
    if (cdl && uadl) try {
        ...
        var cntTZ9GH9 = 0; window.dataLayer_TZ9GH9.forEach(function(e){if(e.event === 'UATC Pay'){cntTZ9GH9 = cntTZ9GH9 + 1}})
        dl.push({'event': 'UATC Pay', 'counter': cntTZ9GH9});
        window.dataLayer_TZ9GH9 && window.dataLayer_TZ9GH9.push({'event': 'UATC Pay', 'counter': cntTZ9GH9});      
    } catch(e) {
        cdl.error('GTM UK TC UATC Pay: '+e); 
    } finally {     
        var counter = 0;
        window.dataLayer_TZ9GH9 && window.dataLayer_TZ9GH9.forEach(function(e){if(e.event === 'UATC Pay'){counter = e.counter || 0}});          
