<script id='GTM-TZ9GH9_uatcdlBook'>
        ...
        cdl.DL_uatc = {
            ...
            webanalytics    : {
                ...
                metrics         : {
                    ...
                    metric6         : {'srppagenbr'                 : parseInt(cdpr.searchresultspagenbr) || 0},
                    metric7         : {'srppages'                   : parseInt(cdpr.searchresultspages) || 0},
                    metric8         : {'srpperpage'                 : parseInt(cdpr.searchresultsperpage) || 0},
                    metric9         : {'srptotal'                   : parseInt(cdpr.searchresultstotal) || 0},
                    metric10        : {'totalprice'                 : +(cdpm.totalprice || 0)},
                    ...
                    metric15        : {'hitcount'                   : 1},
                    metric16        : {'insurancevalue'             : +(cdextras.insurance && cdextras.insurance.addedcost || 0)},
                    metric17        : {'luggagevalue'               : +(cdextras.luggage && cdextras.luggage.addedcost || 0)},
                    metric18        : {'latebookingfee'             : +(cdextras.latefees && cdextras.latefees.addedcost || 0)},
                    ...
                    metric25        : {'charitydonation'            : parseInt(cdextras.donation && +cdextras.donation.selected || 0)},
                    metric26        : {'charitydonation value'      : +(cdextras.donation && cdextras.donation.addedcost || 0)},
                ...
                dimensions      : {
                    ...
                    dimension4      : {'srptop3'                    : cdpr.searchresultstop3 || ''},
                    ...
                    dimension13     : {'resortsrch'                 : cdpr.resort || ''},
