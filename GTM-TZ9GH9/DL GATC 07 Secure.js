<script id='GTM-TZ9GH9_gatcdlSecure'>
(function gtm_gatcdlSecure(cdl, dl, loc) {
    'use strict';
    if (cdl && cdl.CATTParams) try {
        ...
        cdl.error('GTM UK TC GATCDL Secure: '+e);
    } finally {
        dl.push({'event': 'GATCDL Secure'});
        window.dataLayer_TZ9GH9 && window.dataLayer_TZ9GH9.push({'event': 'GATCDL Secure'});
    }
