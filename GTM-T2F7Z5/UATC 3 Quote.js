<script id='GTM-T2F7Z5_UATCQuote'>
  (function gtm_uatcQuote(jQ, cdl, uadl, w, d, dl){
    ...
    if (cdl && uadl && !dl.some(function(a){return /UATC Quote/i.test(a && a.event || '');}) ) try {
      ...
      cdl.error('GTM UK directholidays UATC Quote: '+e);
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'UATC Quote', 'pid': (cdpm.pageid || ''), 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - window.dataLayer[0]['gtm.start']});
    }
