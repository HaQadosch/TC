<script id='gtm_uatcdlSummary'>
(function gtm_uatcdlSummary(jQ, dl, cdl, loc){
    'use strict';
    if (jQ && cdl && cdl.CATTParams) try {
        ...
        cdl.error('GTM BE NEC UATCDL Summary: '+e)
    } finally {
        dl.push({'event': 'UATCDL Summary'})
        window.gatcDL && window.gatcDL.push({'event': 'UATCDL Summary'})
    }
    return cdl.DL_uatc
