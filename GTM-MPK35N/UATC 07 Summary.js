<script id='gtm_uatcSummary'>
(function gtm_uatcSummary(jQ, cdl, uadl, w, d, dl){
    'use strict';
    if (cdl && uadl) try {
        ...
        window.ga && window.ga(function gtm_useTracker() {
            ...
            (function gtm_uatcSummaryAddProduct(){
                ...
                w.ga(trackerName+'ec:setAction','checkout', {'step': 4, 'label': 'summary'})
            ...
            dl.push({'event': 'UATC Summary'});
            window.gatcDL && gatcDL.push({'event': 'UATC Summary'});
        })
    } catch(e) {
        cdl.error('GTM BE NEC UATC Summary: '+e); 
    } finally {     
