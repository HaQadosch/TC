<script id='gtm_uatcdlContacts'>
(function gtm_uatcdlContacts(jQ, dl, cdl, loc){
    'use strict';
    if (jQ && cdl && cdl.CATTParams) try {
        ...
        cdl.error('GTM BE NEC UATCDL Contacts: '+e)
    } finally {
        dl.push({'event': 'UATCDL Contacts'})
        window.gatcDL && window.gatcDL.push({'event': 'UATCDL Contacts'})
    }
    return cdl.DL_uatc
