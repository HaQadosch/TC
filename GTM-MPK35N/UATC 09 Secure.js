...
(function gtm_uatcSecure(jQ, cdl, uadl, w, d, dl){
    ...
    if (cdl && uadl) try {
        ...
        window.ga && window.ga(function gtm_useTracker() {
            ...
            (function gtm_uatcSecureAddProduct(){
                ...
                w.ga(trackerName+'ec:setAction','checkout', {'step': 6, 'label': 'secure'})
            ...
            dl.push({'event': 'UATC Secure'});
            window.gatcDL && gatcDL.push({'event': 'UATC Secure'});
        })
    } catch(e) {
        cdl.error('GTM BE NEC UATC Secure: '+e); 
    } finally {     
