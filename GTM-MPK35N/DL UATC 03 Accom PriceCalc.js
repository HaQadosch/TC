<script id='gtm_uatcdlAccomPriceCalc'>
(function gtm_uatcdlAccomPriceCalc(jQ, dl, cdl, loc) {
    'use strict';
    if (jQ && cdl && cdl.CATTParams) try {
        ...
        cdl.error('GTM BE NEC UATCDL PriceCalc: '+e)
    } finally {
        dl.push({'event': 'UATCDL PriceCalc'})
        gatcDL.push({'event': 'UATCDL PriceCalc'})
    }
