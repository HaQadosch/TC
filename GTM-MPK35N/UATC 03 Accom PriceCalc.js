<script id='gtm_uatcAccomPriceCalc'>
(function gtm_uatcAccomPriceCalc(jQ, cdl, uadl, w, d, dl){
    'use strict';
    if (cdl && uadl) try {
        ...
        window.ga && window.ga(function gtm_useTracker() {
            ...
            dl.push({'event': 'UATC PriceCalc'});
            window.gatcDL && gatcDL.push({'event': 'UATC PriceCalc'});   
        });
    } catch(e) {
        cdl.error('GTM BE NEC UATC PriceCalc: '+e);
    } 
    return cdl && uadl
