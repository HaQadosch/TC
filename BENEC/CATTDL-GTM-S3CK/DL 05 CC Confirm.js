<script>
(function gtm_cattdlCCConfirm(jQ, dl, cdl) {
    'use strict'
    if (jQ && jQ.extend && cdl) try {
        ...
        cdl.error('GTM CATTDL CC Confirm: '+e)
    } finally {
        dl.push({'event': 'pid_'+cdl.CATTParams.pageid});
        dl.push({'event': 'CATTDL CC Confirm'})
        window.gatcDL && gatcDL.push({'event': 'CATTDL CC Confirm'})
    }
