...
(function gtm_gatcSRP(jQ, dl, cdl) {
    'use strict'
        try {
            ...
            if(cdpm.destination){window._gaq.push(['CATTGATC._setCustomVar', 23, 'Country', cdpm.destination, 3])};
            if(cdpm.region){window._gaq.push(['CATTGATC._setCustomVar', 24, 'Region', cdpm.region, 3])};
            if(cdpm.accomresort){window._gaq.push(['CATTGATC._setCustomVar', 25, 'Place', cdpm.accomresort, 3])};           
            if(cdpm.deptdate){window._gaq.push(['CATTGATC._setCustomVar', 26, 'DeptDate', (cdl.gadate && cdpm.deptdate && cdl.gadate(cdpm.deptdate)) , 3])};            
