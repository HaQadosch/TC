<script id='GTM-MSD88R_evtMyAccountResetPW'>
(function gtm_evtMyAccountResetPW(jQ, cdl, uadl, w, d, dl){
    ...
    return cdl && uadl
}(!window.CATTDL?!1:window.CATTDL.jQ, window.CATTDL, !window.CATTDL?!1:window.CATTDL.DL_uatc, window, document, window.dataLayer_MSD88R || []))
</script>