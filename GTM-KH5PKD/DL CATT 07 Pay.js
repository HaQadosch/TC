<script id='GTM-KH5PKD_cattdlPay'>
    ...
    var ld = cdl._;
        ...
        try {
            ...
            cdl.error('GTM  UK TC Cruise CATTDL Pay: '+e);
        } finally {
            var stampEpoch = +new Date();
          dl.push({'event': 'CATTDL Pay', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
        }
