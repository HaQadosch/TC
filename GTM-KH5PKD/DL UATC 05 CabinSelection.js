<script id='GTM-KH5PKD_UATCDLCabinSelection'>
  (function gtm_uatcdlCabinSelection(jQ, cdl, loc, dl){
    'use strict';
    var cdpm;
    var timeStart = 0;
    ...
    try {
      ...
      cdl.error('GTM UK TC Cruise UATCDL CabinSelection: '+e);
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'UATCDL CabinSelection', 'pid': cdpm.pageid || '', 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl.DL_uatc;
