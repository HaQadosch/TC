<script id='GTM-KH5PKD_UATCDLCategorySelection'>
  (function gtm_uatcdlCategorySelection(jQ, cdl, loc, dl){
    'use strict';
    var cdpm;
    var timeStart = 0;
    ...
    try {
      ...
      cdl.error('GTM UK TC Cruise UATCDL CategorySelection: '+e);
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'UATCDL CategorySelection', 'pid': cdpm.pageid || '', 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl.DL_uatc;
