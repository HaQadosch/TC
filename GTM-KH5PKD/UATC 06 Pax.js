<script id='GTM-KH5PKD_UATCPax'>
  (function gtm_uatcPax(jQ, cdl, uadl, w, dl){
    'use strict';
    var cdpm;
    var timeStart = 0;
    ...
    try {
      ...
      if(uaProd.id){
        ...
        w.ga(trackerName+'ec:setAction','checkout', {'step': 4, 'label': 'pax'});
      ...
      cdl.error('GTM UK TC Cruise UATC Pax: '+e);
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'UATC Pax', 'pid': cdpm.pageid || '', 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
