<script id='GTM-KH5PKD_GATCDLCabinSelection'>
  (function gtm_gatcdlCabinSelection(cdl, dl, loc) {
    'use strict';
    ...
    try {
      ...
      cdl.error('GTM UK TC Cruise GATCDL CabinSelection: '+e);
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'GATCDL CabinSelection', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl.DL_gatc;
