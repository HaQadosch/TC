<script id='GTM-KH5PKD_GATCDLPax'>
  (function gtm_gatcdlPax(cdl, dl, loc) {
    ...
    try {
      ...
      cdl.error('GTM UK TC Cruise GATCDL Pax: '+e);
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'GATCDL Pax', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl.DL_gatc;
