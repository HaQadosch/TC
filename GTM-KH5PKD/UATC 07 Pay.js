<script id='GTM-KH5PKD_UATCPay'>
  (function gtm_uatcPay(jQ, cdl, uadl, w, dl){
    'use strict';
    var cdpm;
    var timeStart = 0;
    ...
    try {
      ...
      if(uaProd.id){
        ...
        w.ga(trackerName+'ec:setAction','checkout', {'step': 5, 'label': 'pay'});
      ...
      cdl.error('GTM UK TC Cruise UATC Pay: '+e);
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'UATC Pay', 'pid': cdpm.pageid || '', 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
