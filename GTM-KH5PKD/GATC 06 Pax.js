<script id='GTM-KH5PKD_GATCPax'>
  (function gtm_gatcPax(dl, jQ, cdl, gadl, w, d) {
    'use strict';
    ...
    try {
      ...
      dl.push({'event': 'GATC Pax', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl && gadl;
