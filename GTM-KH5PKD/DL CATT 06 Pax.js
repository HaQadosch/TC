<script id='GTM-KH5PKD_cattdlpax'>
    ...
    var ld = cdl._;
        ...
        try {
            ...
            cdl.error('GTM  UK TC Cruise CATTDL Pax: '+e);
        } finally {
            var stampEpoch = +new Date();
          dl.push({'event': 'CATTDL Pax', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
        }
