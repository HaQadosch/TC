<script id='GTM-KH5PKD_UATCCabinSelection'>
  (function gtm_uatcCabinSelection(jQ, cdl, uadl, w, dl){
    'use strict';
    var cdpm;
    var timeStart = 0;
    ...
    try {
      ...
      if(uaProd.id){
        ...
        w.ga(trackerName+'ec:setAction','checkout', {'step': 3, 'label': 'cabinselection'});
      ...
      cdl.error('GTM UK TC Cruise UATC CabinSelection: '+e);
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'UATC CabinSelection', 'pid': cdpm.pageid || '', 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
