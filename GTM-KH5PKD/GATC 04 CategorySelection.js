<script id='GTM-KH5PKD_GATCCategorySelection'>
  (function gtm_gatcCategorySelection(dl, jQ, cdl, gadl, w, d) {
    'use strict';
    ...
    try {
      ...
      dl.push({'event': 'GATC CategorySelection', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl && gadl;
