<script id='GTM-KH5PKD_GATCDLPay'>
  (function gtm_gatcdlPay(cdl, dl, loc) {
    ...
    try {
      ...
      cdl.error('GTM UK TC Cruise GATCDL Pay: '+e);
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'GATCDL Pay', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl.DL_gatc;
