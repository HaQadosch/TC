<script id='GTM-KH5PKD_UATCDLPax'>
  (function gtm_uatcdlPax(jQ, cdl, loc, dl){
    'use strict';
    var cdpm;
    var timeStart = 0;
    ...
    try {
      ...
      cdl.error('GTM UK TC Cruise UATCDL Pax: '+e);
    } finally {
      var stampEpoch = +new Date();
      dl.push({'event': 'UATCDL Pax', 'pid': cdpm.pageid || '', 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl.DL_uatc;
