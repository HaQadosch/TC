<script id='GTM-KH5PKD_GATCPay'>
  (function gtm_gatcPay(dl, jQ, cdl, gadl, w, d) {
    'use strict';
    ...
    try {
      ...
      dl.push({'event': 'GATC Pay', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl && gadl;
