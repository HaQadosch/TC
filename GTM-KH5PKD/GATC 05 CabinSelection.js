<script id='GTM-KH5PKD_GATCCabinSelection'>
  (function gtm_gatcCabinSelection(dl, jQ, cdl, gadl, w, d) {
    'use strict';
    ...
    try {
      ...
      dl.push({'event': 'GATC CabinSelection', 'pid': cdl.CATTParams.pageid, 'timestamp': stampEpoch, 'since gtm.start': stampEpoch - timeStart});
    }
    return cdl && gadl;
