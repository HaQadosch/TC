    ...
    if (jQ && cdl && cdl.CATTParams) try {
        ...
        if (params && params.srpresults) {
            for (i = 0; i < params.srpresults.length; i++) {
                if (params.srpresults[i] && params.srpresults[i].accomcode && params.srpresults[i].accomcode.toLowerCase() === accId.toLowerCase()) {
                    accPosition = params.srpresults[i].position
        ...
        */
        ...
        cdl.error('GTM BE TC UATCDL Accom: '+e)
    } finally {
