...
(function gtm_gatcdlSubSRP(cdl, dl, loc) {
    ...
    if (cdl && cdl.CATTParams) try {
        ...
        cdl.error('GTM FR TC GATCDL SubSRP: '+e)
    } finally {
        dl.push({'event': 'GATCDL SubSRP'})
    }
    return cdl.DL_gatc || !1
}(window.CATTDL, window.dataLayer || [], document.location || window.location))
</script>
...
(function gtm_gatcdlAccom(cdl, dl, loc) {
    ...
    if (cdl) try {
        ...
        cdl.error('GTM FR TC GATCDL Accom: '+e)
    } finally {
...
<script>
(function gtm_gatcdlPax(cdl, dl, loc) {
    'use strict'
    if (cdl) try {
        var twlh = cdl.twlh
        var cdpm = cdl.CATTParams || {};
        ...
        cdl.error('GTM FR TC GATCDL Pax: '+e)
    } finally {
        dl.push({'event': 'GATCDL Pax'})
    }
    return cdl.DL_gatc || !1
}(window.CATTDL, window.dataLayer || [], document.location || window.location))
</script>
...
(function gtm_gatcdlPay(cdl, dl, loc) {
    ...
    if (cdl) try {
        ...
        cdl.error('GTM FR TC GATCDL Pay: '+e)
    } finally {
...
<script>
(function gtm_gatcSubSRP(jQ, cdl, gadl, w, d) {
    'use strict';
    if (cdl && gadl) try {
        var tn = gadl.trackername+'.' || ''
        var gawa = gadl.webanalytics || {}
        ...
        cdl.error('GTM FR TC GATC SubSRP: '+e)
    }
    return (cdl && gadl)
}(window.jQuery, window.CATTDL, !window.CATTDL?!1:(window.CATTDL.DL_gatc || {}), window, document))
</script>
...
(function gtm_gatcAccom(jQ, cdl, gadl, w, d) {
    ...
    if (cdl && gadl) try {
        ...
        cdl.error('GTM FR TC GATC Accom: '+e)
    }
    return (cdl && gadl)
}(window.jQuery, window.CATTDL, !window.CATTDL?!1:(window.CATTDL.DL_gatc || {}), window, document))
</script>
...
(function gtm_gatcPax(jQ, cdl, gadl, w, d) {
    ...
    if (cdl && gadl) try {
        ...
        cdl.error('GTM FR TC GATC Pax: '+e)
    }
    return (cdl && gadl)
}(window.jQuery, window.CATTDL, !window.CATTDL?!1:(window.CATTDL.DL_gatc || {}), window, document))
</script>
