...
try {
    (function(){
        ...
        s.src   = ('https:'==document.location.protocol?'https://':'http://')
                + 'eu-sonar.sociomantic.com/js/2010-07-01/adpan/thomascook-de';
        x.parentNode.insertBefore( s, x );
    })();
} catch (e){if (typeof console != "undefined") console.log("DE TC Generic SocioMantic: "+e)}
...
} catch (e){if (typeof console != "undefined") console.log("DE TC SRP Accom Category SocioMantic: "+e)}
...
try {
    ...
    if (dateSplit && priceAmount && imagePreview && lob && destination && accomResort){
        window.product = {
            ...
            description: "Finde jetzt deine Traumreise nach " + window.CATTParams.AccomResort.replace(/\+/gi, ' ') +" bei thomascook.de" ,
            url: '',
            photo: imagePreview,
...
try {
    if (/utmcsr=sociomantic/i.test(document.cookie)){
        ...
        if ("object"===typeof sociomantic&&"object"===typeof sociomantic.sonar&&"object"===typeof sociomantic.sonar.adv&&"object"===typeof sociomantic.sonar.adv["thomascook-de"]&&"function"===typeof sociomantic.sonar.adv["thomascook-de"].getConfirmed){
            sociomantic.sonar.adv["thomascook-de"].getConfirmed();
        }
    }
} catch (e){if (typeof console != "undefined") console.log("DE TC Booking SocioMantic: "+e)}
