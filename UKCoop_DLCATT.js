...
(function gtm_cattdlCore(jQ, d, w, dl) {
    ...
    if (jQ && dl) try {
        ...
        w.CATTDL = {
            ...
            post    : function post(key, value) {document.cookie = key+"="+value+"; path=/; domain=.co-operativetravel.co.uk;"},
...
(function gtm_cattdlCore(jQ, d, w, dl) {
    ...
    if (jQ && dl) try {
        ...
        cdpm['lob'] = cdpm.lob
            || cdpm.cookies.gtm_lob
            || w.CATTDL && w.CATTDL.ckget && w.CATTDL.ckget('gtm_lob')
            || ''
