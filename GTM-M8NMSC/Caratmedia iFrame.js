<script id='GTM-M8NMSC_carat'>(function gtm_caratMediaDL(cdl, edl){
	'use strict';
	if (cdl && edl)
	{
		try {
...
(function gtm_caratmedia(cdl, jQ, cmdl, edl){
 ...
 }(window.CATTDL, window.jQuery, !window.CATTDL?!1:window.CATTDL.DL_caratmedia, window.dataLayer_M8NMSC))</script>
