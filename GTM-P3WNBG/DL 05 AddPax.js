<script id='GTM-P3WNBG_cattdlAddPax'>
(function gtm_cattdlAddPax(jQ, dl, cdl) {
    'use strict'
    if (jQ && jQ.extend && cdl) try {
        ...
        cdl.error('GTM CATTDL AddPax: '+e)
    } finally {
        dl.push({'event': 'pid_'+cdl.CATTParams.pageid});
        dl.push({'event': 'CATTDL AddPax'}) 
        window.dataLayer_TZ9GH9 && dataLayer_TZ9GH9.push({'event': 'CATTDL AddPax'})
    }
    return cdl
