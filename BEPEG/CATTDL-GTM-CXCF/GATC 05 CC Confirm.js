<script>
(function gtm_gatcCCConfirm(jQ, dl, cdl) {
    'use strict'
        try {
            var ctpm = CATTParams || {};
            ...
            window._gaq.push(['CATTGATC._setAccount', 'UA-37141618-1']);
            window._gaq.push(['CATTGATC._setDomainName', 'pegase.be']);
            window._gaq.push(['CATTGATC._addIgnoredRef','pegase.be'])
            ...
            window.CATTDL && CATTDL.info('GTM GATC CC Confirm: '+e)
        } finally {
            window.dataLayer && dataLayer.push({'event' : 'GATC CC Confirm'})
        }
