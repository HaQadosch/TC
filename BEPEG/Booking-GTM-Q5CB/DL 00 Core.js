    ...
    if (jQ) {
        try{
            ...
            w.CATTDL = {
                ...
                post    : function post(key, value) {document.cookie = key+"="+value+"; path=/; domain=.pegase.be;"},
            ...
            var domainName = ({
                'pegase':'.pegase.be'
            })[((/([^\.]*).be|([^\.]*).com|([^\.]*).net/i.exec(location.hostname) || []).filter(function hostname(e){return e}) || ['pegase']).pop()];
